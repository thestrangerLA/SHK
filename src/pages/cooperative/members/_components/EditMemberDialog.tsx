...
export function EditMemberDialog({ open, onOpenChange, member, onMemberUpdate }: EditMemberDialogProps) {
    ...
    const handleDepositChange = (currency: 'kip' | 'thb' | 'usd' | 'cny', value: string) => {
        setFormData(prev => ({
            ...prev,
            deposits: {
                ...(prev.deposits || { kip: 0, thb: 0, usd: 0, cny: 0 }),
                ...
                <div className="grid gap-4 py-4">
                    ...
                    <div className="grid gap-2">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                            ...
                            <Input placeholder="CNY" type="number" value={formData.deposits?.cny || ''} onChange={(e) => handleDepositChange('cny', e.target.value)} />
                        </div>
                    </div>
                </div>
                <DialogFooter>
